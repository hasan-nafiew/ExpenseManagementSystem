                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="col-md-6 text-right padnone">
                                <a href="{{url('/admin/income/category/add')}}" class="btn btn-info btn-fill btn-sm btnu"><i class="fa fa-plus-circle"></i> Add Category</a>
                            </div>
                                ...
                                <table id="alltableinfo" class="table table-striped table-bordered table_customize">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$data->incate_time}}</td>
                                            <td>
                                                <a href="{{url('admin/income/category/view/'.$data->incate_id)}}"><i class="fa fa-plus-square fa-lg man_view"></i></a>
                                                <a href="{{url('admin/income/category/edit/'.$data->incate_id)}}"><i class="fa fa-edit fa-lg man_edit"></i></a>
                                                <a id="softDelete" data-toggle="modal" data-target="#mySoftDelete" data-id="{{$data->incate_id}}" href="#"><i class="fa fa-trash fa-lg man_delete"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
