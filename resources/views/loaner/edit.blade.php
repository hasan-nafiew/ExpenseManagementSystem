                            ...
                            <div class="panel-body">
                                ...
                                <div class="add_admin_info">
                                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="hidden" name="id" class="form-control input_field" id="" value="{{$data->loaner_id}}">
                                            <input type="text" name="name" class="form-control input_field" id="" value="{{$data->loaner_name}}">
                                    ...
                                    <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="phone" class="form-control input_field" id="" value="{{$data->loaner_phone}}">
                                            <span class="help-block">
                                    ...
                                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="email" name="email" class="form-control input_field" id="" value="{{$data->loaner_email}}">
                                            <span class="help-block">
                                    ...
                                    <div class="form-group{{ $errors->has('remarks') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="remarks" class="form-control input_field" id="" value="{{$data->loaner_remarks}}">
                                            <span class="help-block">
