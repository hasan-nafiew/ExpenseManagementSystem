        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card bootstrap-iso">
                    <form class="form-horizontal" method="post" action="{{url('/admin/expense/category/update')}}">
                        {{csrf_field()}}
                            ...
                            <div class="panel-body">
                                ...
                                <div class="add_admin_info">
                                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="hidden" name="id" class="form-control input_field" id="" value="{{$data->expcate_id}}">
                                            <input type="text" name="name" class="form-control input_field" id="" value="{{$data->expcate_name}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="remarks" class="form-control input_field" id="" value="{{$data->expcate_remarks}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
